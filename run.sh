...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -u train.py $DATA_DIR --save-dir $SAVE_DIR --tensorboard-logdir $SAVE_DIR --fp16 --train-subset train --valid-subset valid --no-epoch-checkpoints --best-checkpoint-metric loss --num-workers 4 \
